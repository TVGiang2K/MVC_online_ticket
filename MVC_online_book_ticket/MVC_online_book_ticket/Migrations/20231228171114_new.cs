    ...
    public partial class @new : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Accounts",
                columns: new[] { "AccountsId", "Age", "Avatar", "Create_date", "Delete_date", "Gender", "Name", "Password", "Phone", "Position", "Qualification", "Role", "Update_date", "Username" },
                values: new object[] { 1, (byte)30, "admin-avatar-url", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, true, "Quản trị viên", "oSBAHbpB4kn7X7QOcrBtXDaUaFtSU+/ymFHV1PkWNtOQOhTyqwPDoizoJyKlT5W5", "123456789", "Vị trí Quản trị viên", "Chứng chỉ Quản trị viên", 0, null, "admin" });
